...
public class Admadd_Flight extends JFrame{ 

    
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;

        public Admadd_Flight(){
            ...
            JLabel AddFlights = new JLabel("ADD FLIGHT DETAILS");
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    try {
                        ...
                        c.s.executeUpdate("INSERT INTO flight(flight_code,flight_name,source,destination)values('"+flight_code+"','"+flight_name+"','"+source+"','"+destination+"')");
                        c.s.executeUpdate("INSERT INTO sector(flight_code,capacity,class_code,class_name)values('"+flight_code+"','"+capacity+"','"+class_code+"','"+class_name+"')");
