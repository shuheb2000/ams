	...
	btnShow.setFont(new Font("Tahoma", Font.PLAIN, 20));
        ...
        btnShow.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    conn c = new conn();
                    String str = "select flight.flight_code,flight_name,source,destination,capacity,class_code,class_name from flight,sector where flight.flight_code='"+code+"' and sector.flight_code='"+code+"'";                 
